...
//added from resources 
	//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	  ...
	  /*
	  class CustomerResultSetExractor implements ResultSetExtractor<Customer> {
	...
	//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		//$$$$$$$$$$$$$comment out as we added the same from the source folder
		/*
	@Override
		public Optional <Customer> fetchCustomer(String customerId) {
		 String sql = ""
		 ...
		 params.put("customer_id",  customerId);
			...
			return Optional.ofNullable(jdbcTemplate.query(sql, params, new CustomerResultSetExractor()));
		}
	*/
	//***************commented out as we added same from source folder*************************************************
...
*/
	...
	//**************************************************
		...
		private NamedParameterJdbcTemplate jdbcTemplate;
		*/
		//%%%%%%%%commented out above as we added same from source folder
